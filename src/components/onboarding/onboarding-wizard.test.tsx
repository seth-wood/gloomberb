...
describe("OnboardingWizard", () => {
  ...
  test("imports a broker portfolio before moving to Cloud", async () => {
    ...
    expect(capturedConfig?.portfolios.some((portfolio) => portfolio.id === "broker:demo-demo-broker:ACC-1")).toBe(true);
    expect(capturedConfig?.layout.instances.find((instance) => instance.paneId === "portfolio-list")?.params?.collectionId)
